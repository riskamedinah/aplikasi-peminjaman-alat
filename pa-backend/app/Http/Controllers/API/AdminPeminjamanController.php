    ...
    public function store(AdminPeminjamanRequest $request)
    {
        ...
        try {
            ...
            LogAktivitas::create([
                ...
                'peminjaman_id' => $peminjaman->id,
                'aksi' => 'create',
                'keterangan' => 'Admin ' . $currentUser->name . ' membuat peminjaman untuk ' . $targetUserName . ' (Status: ' . $peminjaman->status . ')',
            ]);
    ...
    public function update(AdminPeminjamanRequest $request, Peminjaman $peminjaman)
    {
        ...
        try {
            ...
            LogAktivitas::create([
                ...
                'peminjaman_id' => $peminjaman->id,
                'aksi' => 'update',
                'keterangan' => 'Admin ' . $currentUser->name . ' mengupdate peminjaman (Status: ' . $oldStatus . ' → ' . $newStatus . ')',
            ]);
    ...
    public function destroy(Request $request, Peminjaman $peminjaman)
    {
        ...
        try {
            ...
            LogAktivitas::create([
                ...
                'aksi' => 'delete',
                'keterangan' => 'Admin ' . $currentUser->name . ' menghapus peminjaman status ' . $peminjamanStatus,
            ]);
            
            // Baru delete peminjaman
            $peminjaman->detailPeminjaman()->delete();
            $peminjaman->delete();
